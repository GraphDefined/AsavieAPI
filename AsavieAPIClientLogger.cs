...
namespace com.GraphDefined.Asavie.API
{
    ...
    /// <summary>
    /// The Asavie API logger.
    /// </summary>
    public class AsavieAPIClientLogger : HTTPClientLogger
    {
        ...
        /// </summary>
        public const String DefaultContext = "AsavieAPI";
        ...
        /// <summary>
        /// The attached Asavie API client.
        /// </summary>
        public AsavieAPIClient  AsavieAPIClient   { get; }

        #endregion

        #region Constructor(s)

        #region AsavieAPIClientLogger(AsavieAPIClient, Context = DefaultContext, LogFileCreator = null)
        ...
        #region AsavieAPIClientLogger(AsavieAPIClient, Context, ... Logging delegates ...)
